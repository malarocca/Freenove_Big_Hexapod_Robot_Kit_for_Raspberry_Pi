...
LOG_PATH = "longmode_longbudget_log.csv"

tof = VL53L1X.VL53L1X(i2c_bus=1, i2c_address=0x29)
tof.open(reset=True)
tof.start_ranging(3)  # long range mode
tof.set_timing(140000, 150)  # 140ms integration budget (vs. ~33ms default) for better SNR at range

print("Long mode + 140ms timing budget (higher SNR for weak far-range signal).")
print("In the open area, hold target at 100cm, then move it in to ~10cm and back out.")
