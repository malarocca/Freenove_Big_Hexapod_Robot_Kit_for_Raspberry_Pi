...
"font: 10pt \"Arial\";")
        ...
        self.Button_Auto = QtWidgets.QPushButton(client)
        self.Button_Auto.setGeometry(QtCore.QRect(150, 510, 110, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.Button_Auto.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_Auto.setObjectName("Button_Auto")
        self.label_Auto_Status = QtWidgets.QLabel(client)
        self.label_Auto_Status.setGeometry(QtCore.QRect(270, 510, 160, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.label_Auto_Status.setFont(font)
        self.label_Auto_Status.setStyleSheet("font: 10pt \"Arial\"; color: #DCDCDC;")
        self.label_Auto_Status.setAlignment(QtCore.Qt.AlignCenter)
        self.label_Auto_Status.setObjectName("label_Auto_Status")
...
"font: 10pt \"Arial\";")
    ...
    def retranslateUi(self, client):
        ...
        self.Button_Auto.setText(_translate("client", "Start Auto Mode"))
        self.label_Auto_Status.setText(_translate("client", "Auto Mode: Off"))
